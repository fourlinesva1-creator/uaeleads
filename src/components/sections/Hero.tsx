...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-end overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container-luxury py-16 lg:py-24 w-full">
        <div className="max-w-4xl animate-fade-in-up">
          ...
          <h1 className="heading-hero text-white mb-6">
            <span className="heading-hero-bold">{t('titleBold')}</span>
            <br />
            <span className="heading-hero-light">{t('titleLight')}</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            {/* WhatsApp — primary action during Ramadan */}
            <a
