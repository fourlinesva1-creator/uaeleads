    ...
    return {
        ...
        alternates: {
            ...
            languages: {
                ...
                'x-default': 'https://www.tentnow.ae/en/blog/iftar-tent-rental-checklist-uae-2026',
            },
        },
        openGraph: {
            title,
            description,
            images: [{ url: 'https://www.tentnow.ae/images/tent-now/iftar-tents.jpg', width: 1200, height: 630 }],
            type: 'article',
        },
    };
}
